...
test_blog_template_uses_gazeta_layout() {
  ...
  [ -f "$test_web_root/mytestblog/site/lodestone/pages/blog.stone.html" ] || {
    TEST_FAILURE_REASON="Gazeta Lodestone blog page was not copied into site/lodestone/pages"
    rm -rf "$test_web_root"
    return 1
  }
