...
mode_runtime_lib="$root/templates/web/artificer/cgi/mode-runtime-lib.sh"
...
assert_contains "$mode_runtime_lib" "mr_failure_taxonomy_query_json()"
assert_contains "$mode_runtime_lib" "mr_failure_taxonomy_query_response()"
...
assert_contains "$ui_js" "function modeRuntimeQueryFailureTaxonomy(filterOverrides)"
...
assert_contains "$ui_js" "data-action='mode-runtime-taxonomy-query'"
assert_contains "$ui_js" "data-action='mode-runtime-taxonomy-query-reset'"
...
assert_contains "$backlog" "sustained-regression gating"
