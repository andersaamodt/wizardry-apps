...
assert_contains "$ui_js" "apiPost(\"dictation_install_cancel\", { job_id: jobId }, { timeoutMs: 4000 })"
...
assert_contains "$ui_js_source" "apiPost(\"dictation_install_cancel\", { job_id: jobId }, { timeoutMs: 4000 })"
