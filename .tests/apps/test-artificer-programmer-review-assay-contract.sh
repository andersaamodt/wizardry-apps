...
assert_contains "$api" "normalize_assay_task_id_value()"
...
assert_contains "$api" "queue_meta_assay_task_id_from_file()"
assert_contains "$api" "\"programmer_review\":\"%s\""
assert_contains "$api" "\"programmer_review_rounds\":\"%s\""
assert_contains "$api" "\"assay_task_id\":\"%s\""
...
assert_contains "$api" "assay_task_id_raw=\$(trim \"\$(param \"assay_task_id\")\")"
...
assert_contains "$ui_js" "function buildAssayMentorSnapshot()"
assert_contains "$ui_js" "function buildAssayMentoredPromptForTask(task, mentorSnapshot)"
...
assert_contains "$ui_js" "assay_task_id: explicitAssayTaskId,"
...
assert_contains "$ui_js" "assay_task_id: normalizedAssayTaskId,"
assert_contains "$ui_js" "assay_task_id: normalizeAssayTaskId(item.assay_task_id || \"\"),"
...
assert_contains "$style" ".assay-task-metrics {"
assert_contains "$style" ".assay-task-focus {"
