...
- Cross-platform starters: minimal, Homestead reference shell, control panel, left sidebar, top bar + graph, dashboard, and studio
...
sh apps/forge/scripts/forge-backend.sh scaffold-app /path/to/wizardry-apps reference-tool "Reference Tool" homestead
