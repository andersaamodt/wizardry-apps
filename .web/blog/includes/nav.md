...
<div class="auth-modal" id="auth-modal" hidden>
  ...
  <div class="auth-modal-panel" role="dialog" aria-modal="true" aria-labelledby="auth-modal-title">
    ...
    <p class="auth-modal-help">Desktop login uses NIP-07 when available. Recommended signer extension: <a class="auth-inline-link" href="https://getalby.com/" target="_blank" rel="noopener noreferrer">Install Alby</a>.</p>
