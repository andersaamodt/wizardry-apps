(function () {
  ...
  function composeIconSvgPaths() {
    return [
      { id: "streamline-pixel:content-files-quill-ink", viewBox: "0 0 32 32", body: "<path fill=\"currentColor\" d=\"M27.435 3.05h1.52V1.52h1.52V0h-9.14v1.52h6.1zm-1.53 0h1.53v1.52h-1.53Zm-1.52 1.52h1.52V6.1h-1.52Zm-1.52 1.53h1.52v1.52h-1.52Zm-1.53 1.52h1.53v3.05h-1.53Zm0-4.57h1.53v1.52h-1.53Zm-1.52 7.62h1.52v1.52h-1.52Zm0-6.1h1.52V6.1h-1.52Z\"/><path fill=\"currentColor\" d=\"M18.285 1.52h3.05v1.53h-3.05Zm0 4.58h1.53v1.52h-1.53Zm-1.52 6.09h3.05v1.53h-3.05Zm0-4.57h1.52v1.52h-1.52Zm0-4.57h1.52v1.52h-1.52ZM3.055 32h13.71v-1.52h1.52v-6.1h-1.52v1.53h-7.62v-1.53H6.1v-1.52H3.055v1.52h-1.53v6.1h1.53Zm1.52-6.09H6.1v3.04h3.05v1.53H6.1v-1.53H4.575Zm10.67-16.77h1.52v1.53h-1.52Zm0-4.57h1.52V6.1h-1.52Z\"/><path fill=\"currentColor\" d=\"M13.715 22.86h3.05v1.52h-3.05Zm3.05-9.14h-3.05v-1.53h-1.52v-1.52h-1.52v4.57h6.09z\"/><path fill=\"currentColor\" d=\"M13.715 10.67h1.53v1.52h-1.53Zm0-4.57h1.53v1.52h-1.53Zm-1.52 1.52h1.52v3.05h-1.52Zm-4.57 12.19h4.57v3.05h1.52v-3.05h1.53v-1.52h-4.57v-3.05h-1.53v3.05h-4.57v1.52h1.52v3.05h1.53z\"/>", name: "fav-quill-ink" },
      { id: "mdi:quill", viewBox: "0 0 24 24", body: "<path fill=\"currentColor\" d=\"M22 2s-7.64-.37-13.66 7.88C3.72 16.21 2 22 2 22l1.94-1c1.44-2.5 2.19-3.53 3.6-5c2.53.74 5.17.65 7.46-2c-2-.56-3.6-.43-5.96-.19C11.69 12 13.5 11.6 16 12l1-2c-1.8-.34-3-.37-4.78.04C14.19 8.65 15.56 7.87 18 8l1.21-1.93c-1.56-.11-2.5.06-4.29.5c1.61-1.46 3.08-2.12 5.22-2.25c0 0 1.05-1.89 1.86-2.32\"/>", name: "mdi-quill" },
      { id: "streamline-kameleon-color:quill-paper", viewBox: "0 0 48 48", body: "<g fill=\"currentColor\"><path d=\"M24 48c13.255 0 24-10.745 24-24S37.255 0 24 0S0 10.745 0 24s10.745 24 24 24Z\" opacity=\".18\"/><path d=\"M10.04 11.71c0-.93.75-1.67 1.67-1.67H24l6.98 5.86v20.38c0 .93-.75 1.68-1.67 1.68H11.71c-.92 0-1.67-.75-1.67-1.68Z\"/><path d=\"M24 10.04v4.19c0 .92.75 1.67 1.68 1.67h5.3z\"/></g>", name: "quill-paper" },
      { id: "streamline-kameleon-color:quill-paper-duo", viewBox: "0 0 48 48", body: "<g fill=\"currentColor\"><path d=\"M24 48c13.255 0 24-10.745 24-24S37.255 0 24 0S0 10.745 0 24s10.745 24 24 24Z\" opacity=\".18\"/><path d=\"M11.71 10.03c-.93 0-1.68.75-1.68 1.68v24.57c0 .93.75 1.68 1.68 1.68h17.59c.93 0 1.68-.75 1.68-1.68V15.9l-6.98-5.87z\"/></g>", name: "quill-paper-duo" },
      { id: "streamline-freehand:notes-quill", viewBox: "0 0 24 24", body: "<path fill=\"currentColor\" d=\"M22.47 11.1c-.24-.38-.72-.39-1.17-.33a9.85 9.85 0 0 0-5 2.38a6.74 6.74 0 0 0-2.92 5.84a5.7 5.7 0 0 0 .4 2.2c-.7.79-1.3 1.62-1.78 2.51c0 .23.29.42.62.21a45 45 0 0 0 3.3-3.84a43 43 0 0 0 2.43-4.07\"/>", name: "notes-quill" },
      { id: "streamline-pixel:content-files-quill-ink", viewBox: "0 0 32 32", body: "<path fill=\"currentColor\" d=\"M27.435 3.05h1.52V1.52h1.52V0h-9.14v1.52h6.1zM3.055 32h13.71v-1.52h1.52v-6.1h-1.52v1.53h-7.62v-1.53H6.1v-1.52H3.055v1.52h-1.53v6.1h1.53z\"/>", name: "pixel-quill-ink" },
      { id: "game-icons:quill-ink", viewBox: "0 0 512 512", body: "<path fill=\"currentColor\" d=\"M496.938 14.063c-95.14 3.496-172.297 24.08-231.282 55.812l-29.47 49.28l-4.967-28.093c-10.535 7.402-20.314 15.222-29.314 23.407\"/>", name: "game-quill-ink" },
      { id: "game-icons:scroll-quill", viewBox: "0 0 512 512", body: "<path fill=\"currentColor\" d=\"M311.9 47.95c-17.6 0-34.6.7-50.7 2.43L244.6 93.5l-4.9-40.04c-2.5.46-5 .94-7.5 1.47\"/>", name: "scroll-quill" },
