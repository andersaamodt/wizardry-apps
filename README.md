...
wizardry-apps, Forge itself, and built-in wizardry apps are licensed under `OWL 3.1`, which permits non-commercial use, copying, modification, and sharing. The root [LICENSE](LICENSE) file is the public licensing overview for this split.
...
The Governed Work Kernel is a required external dependency for governed work-record execution. It is installed as a separately licensed AGPL-3.0-or-later upstream workspace and called through a process/file boundary; its source is not vendored into wizardry-apps, Forge, or Artificer.
