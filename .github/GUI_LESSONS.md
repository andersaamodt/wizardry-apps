...
- Do not feed `territory-master.png` directly into macOS bundle icon selection when a generated `.icns` or final `forge-icon.png` exists; territory-safe masters are pipeline intermediates and will put packaged app icons back in app icon jail.
